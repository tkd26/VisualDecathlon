...
from models0.model_WideRes import WideResNet as WideResNet
from models0.model_WideRes_mask import WideResNet as WideResNet_mask
from models0.model_WideRes_STL import WideResNet as WideResNet_STL
from models0.model_ResNetbase import ResNetBaseNet

from utils.optimizer0 import *
...
if not os.path.exists('./weights0/{}'.format(save_name)):
    os.makedirs('./weights0/{}'.format(save_name))
...
for index in range(load_epoch, total_epoch):
    ...
    print('===================================================')
    torch.save(model.state_dict(), 'weights0/{}/{:0=5}.pth'.format(save_name, index+1))
